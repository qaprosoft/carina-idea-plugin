...
public class WebElementInspection extends AbstractBaseJavaLocalInspectionTool {

  private static final Logger LOGGER = Logger.getLogger(WebElementInspection.class);
  ...
  @NonNls
  private static final String DESCRIPTION_TEMPLATE = "Use ExtendedWebElement";

  @NotNull
  public String getDisplayName() {
    return "Use ExtendedWebElement instead of WebElement";
  }
